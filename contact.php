...
$subject ="Новая заявка с сайта creatives";
...
$header .= "From: Новая заявка <innatan.bb@gmail.com>\n\n";	
$mail = mail("innatan.bb@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
